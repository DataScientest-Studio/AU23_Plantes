...
"""
    ...
    Stage 6 : advanced  classification L1 + fine-tuning with background removal
    comparison between the 2 selected models : Mobilnetv3 and Resnet


"""

class Stage6(lm.models.Trainer):
    # abstract class
    record_name = "none"
...
class Stage6MobileNetv3(Stage6):
    record_name = "Stage-6_MobileNetv3"
...
class Stage6ResNetv2(Stage6):
    record_name = "Stage-6_ResNetv2"
