...
#stage2_mobilenet.fit_or_load(campain_id=campaign_id, training=False)
...
#stage3_mobilenet.fit_or_load(campain_id=campaign_id, training=False)
...
stage4_mobilenet.fit_or_load(campain_id=campaign_id, training=True)
