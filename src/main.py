...
lm.models.FIGURE_DIR='../reports/figure'
...
stage2_mobilenet.evaluate()
stage2_mobilenet.print_classification_report()
...
stage3_mobilenet.print_classification_report()
...
stage4_mobilenet.evaluate()
stage4_mobilenet.print_classification_report()
